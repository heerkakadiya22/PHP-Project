     ...
     ?>
      ...
      <div class="section article-post">
        ...
        <div class="blog-post-hero-image-wrap">
          <div
            style="background-image:url(asset/image/teen.jfif)"
            class="blog-post-image"
          ></div>
        </div>

        <?php	
$sql = "SELECT * from usertype where usertype_id= 2";
         ...
         <!--<div class="article-date">July 19, 2019</div>-->
          <div class="rich-text-block w-richtext">
            ...
            <figure style="max-width:1600px" class="w-richtext-align-fullwidth w-richtext-figure-type-image">
              <div>
                <img
                  src="asset/image/Teen_ Turns.jfif"
                  loading="lazy"
                  alt=""
                />
              </div>
        ...
        <div class="newsletter">
          <div class="newsletter-title-and-image-wrap">
            <div class="form-wrap">
            <h2 class="title" style="text-align: center;">FOR<span class="e2a57b"> <br> TEENS</span></h2>
              <p class="align-center">Support and advice on health, emotions, and life – designed for teens and approved by doctors</p>
              <a href="signup.php" class="submit-button w-button" style="text-align: center;"> Teens Site</a>
            </div>
          </div>
      ...
      <div id="Join-Community" class="section">
        <div class="container side-by-side">
          <div class="_45-percent-width-wrap">
            <div class="image-wrap"><div class="image"><img src="asset/image/bully.jfif" alt="" style="height: 100%;"></div></div>
          </div>
          <div class="join-the-community">
            <div class="title-wrap">
            <h2 class="title">FOR<span class="e2a57b"> TEENS. . . </span></h2>
            ...
            <div class="form-block w-form">
              <p class="align-center">Support and advice on health, emotions, <br>and life – designed for teens and approved by doctors. </p>
              <a href='signup.php'> 
