     ...
     ?>
      ...
      <div class="section article-post">
        ...
        <div class="blog-post-hero-image-wrap">
          <div
            style="background-image:url(asset/image/adultage.jfif)"
            class="blog-post-image"
          ></div>
        </div>

        <?php	
$sql = "SELECT * from usertype where usertype_id= 3";
        ...
        <div class="newsletter">
          <div class="newsletter-title-and-image-wrap">
            <div class="form-wrap">
            <h2 class="title" style="text-align: center;">FOR<span class="e2a57b"> <br> ADULTS</span></h2>
              <p class="align-center">You think that adulthood will hit and you'll suddenly be more capable. But that doesn't happen, ever, does it?</p>
              <a href="signup.php" class="submit-button w-button" style="text-align: center;"> Adults Site</a>
            </div>
          </div>
      ...
      <div id="Join-Community" class="section">
        <div class="container side-by-side">
          <div class="_45-percent-width-wrap">
            <div class="image-wrap"><div class="image"><img src="asset/image/adult gre.jfif" alt="" style="height: 100%;"></div></div>
          </div>
          <div class="join-the-community">
            <div class="title-wrap">
            <h2 class="title">FOR<span class="e2a57b"> ADULTS. .  </span></h2>
