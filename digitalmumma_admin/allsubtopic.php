          ...
          <div class="card">
            <div class="card-body">
              ...
              <table class="table datatable" id="headerTable">
				...
				?>
                  <tr>
					<td><?php echo $row["subtopic_id"]; ?></td>
                    ...
                    <td><a href="edit_subtopic.php?id=<?php echo $row['subtopic_id']; ?>"><i class="fas fa-edit"></i></a></td>
                    <td><a href="javascriptvoid:(0)" data-delid="<?php echo $row['subtopic_id']; ?>"class="delete"><i class="fas fa-trash-alt"></i></a></td>
                                           </tr>
                <?php
