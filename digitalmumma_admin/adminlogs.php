...
<main id="main" class="main">
    ...
    <div class="pagetitle">
        <h1>All the adminlogs</h1>
        <nav>
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="index.php">Home</a></li>
                <li class="breadcrumb-item">Manage logs</li>
                <li class="breadcrumb-item active">manage admin logs</li>
            </ol>
        </nav>
    </div>
	  <!-- Add a button/icon to delete all logs -->
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <table class="table datatable" id="headerTable">
                            ...
                            <tbody>
                                <?php
                                    $sql = "SELECT * FROM admin_login_logs";
