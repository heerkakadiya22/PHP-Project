        ...
        <div class="row">
            ...
            <label>
                <select class="datatable-selector"><option value="5">5</option><option value="10" selected="">10</option><option value="15">15</option><option value="-1">All</option></select> entries per page
						...
						<input class="datatable-input" placeholder="Search..." type="search" title="Search within table" aria-controls="headerTable">
                        <table class="table datatable"id="headerTable">
                            ...
                            <tbody>
                                <?php
                                    $sql = "SELECT categories.*, usertype.usertype FROM categories LEFT JOIN usertype ON categories.usertype_id = usertype.usertype_id;";
                                ...
                                ?>
                                            <tr>
                                                ...
                                                <td><a href="edit_category.php?id=<?php echo $row['cat_id']; ?>"><i class="fas fa-edit"></i></a></td>
                                                <td> <td><a href="javascriptvoid:(0)" data-delid="<?php echo $row['cat_id']; ?>"class="delete"><i class="fas fa-trash-alt"></i></a></td>
                                           </tr>
                                <?php
                                        }
                                    } else {
