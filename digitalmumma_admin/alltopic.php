                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <table class="table datatable"id="headerTable">
                            ...
                            <tbody>
                                <?php
                                    $sql = "SELECT topic.*, usertype.usertype FROM topic LEFT JOIN usertype ON topic.usertype_id = usertype.usertype_id;";
                                ...
                                ?>
                                            <tr>
                                                ...
                                                <td><?php echo $row["topic_details"]; ?></td>
                                                <td><?php echo $row["usertype"]; ?></td>
                                                <td><?php echo $row["created_date"]; ?></td>
                                                <td><?php echo $row["lastupdated_date"]; ?></td>
                                                <td><a href="edit_topic.php?id=<?php echo $row['topic_id']; ?>"><i class="fas fa-edit"></i></a></td>
												  <td><a href="javascriptvoid:(0)" data-delid="<?php echo $row['topic_id']; ?>"class="delete"><i class="fas fa-trash-alt"></i></a></td>
                                             </tr>
                                <?php
                                        }
                                    } else {
