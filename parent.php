     ...
     ?>
      ...
      <div class="section article-post">
        ...
        <div class="blog-post-hero-image-wrap">
          <div
            style="background-image:url(asset/image/parent1.jpg)"
            class="blog-post-image"
          ></div>
        </div>
        <?php	
$sql = "SELECT * from usertype where usertype_id= 1";
         ...
         <!--<div class="article-date">July 19, 2019</div>-->
          ...
          <?php echo $row["user_description"]; ?>
            ...
            <figure style="max-width:1600px" class="w-richtext-align-fullwidth w-richtext-figure-type-image">
              <div>
                <img
                  src="asset/image/with baby.jfif"
                  loading="lazy"
                  alt=""
                />
              </div>
        ...
        <div class="newsletter">
          <div class="newsletter-title-and-image-wrap">
            <div class="form-wrap">
            <h2 class="title" style="text-align: center;">FOR<span class="e2a57b"> <br> PARENTS</span></h2>
              <p class="align-center">Advise on children's health, behavior, and growth- from before birth through the teen years.</p>
              <a href="signup.php" class="submit-button w-button" style="text-align: center;"> Parents Site</a>
            </div>
          </div>
      ...
      <div id="Join-Community" class="section">
        <div class="container side-by-side">
          <div class="_45-percent-width-wrap">
            <div class="image-wrap"><div class="image"><img src="asset/image/parent.jfif" alt="" style="height: 100%;"></div></div>
          </div>
          <div class="join-the-community">
            <div class="title-wrap">
            <h2 class="title">FOR<span class="e2a57b"> PARENTS. . . </span></h2>
            ...
            <div class="form-block w-form">
              <p class="align-center">Advise on children's health, behavior, and growth- <br>from before birth through the teen years.<br>
              Watch your children grow, and they will teach you what you've taught them. </p>
              <a href='signup.php'> 
